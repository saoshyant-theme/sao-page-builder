...
function sao_template_option_save(){
	...
	echo '<div class="sao_options_middle">';
		...
		echo '<div class="sao_options_title">';
			echo '<h3>'.esc_html__('Save','sao').' '.esc_html($_REQUEST['name']).' '.esc_html__('Template','sao').'</h3><i class="sao_options_close"></i>';
		echo '</div>';
		//Content
...
function sao_template_options() {
	...
	echo '<div class="sao_model_middle">';
		//Title
		echo '<div class="sao_model_title"><h3>'.esc_html__('Add','sao').' '.esc_attr($_REQUEST['name']).' '.esc_html__('Template','sao').'</h3><i class="sao_model_close"></i></div>';
		//Content;
