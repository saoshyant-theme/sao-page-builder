...
add_filter('sao_element_options', 'sao_icon_text_2_options');
function sao_icon_text_2_options( $element ) {
	$option = array();
	
 	$item = array(
 		'name'			=> 	esc_html('Icon & Text 2','sao'),
 		'id'			=> 'icon_text_2',
		'img'			=>  plugin_dir_url( __DIR__ ).'assets/image/icon_text_2.jpg'
  	); 
...
function sao_icon_text_2_config( $args ) {
	...
	//OutPut
    $output.='<div class="sao-icon-text-2  '.esc_attr($icon).' '.esc_attr($alignment).' sao-post ">'; 
     
	if(!empty($option['icon'])) { 
		$output.='<div class="sao-icon sao-auto-width-item">';
