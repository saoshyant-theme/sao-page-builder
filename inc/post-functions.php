...
function sao_post_module_1($arge=false) { 
		...
		$output ='<div class="sao-post sao-post-module-1 sao-auto-width-post '.esc_attr($thumbnail).'  ">';
...
function sao_post_module_2($arge=false) { 
		...
		$thumbnail = has_post_thumbnail() ? ' has-post-thumbnail ':'';
		$output ='<div class="sao-post sao-post-module-2 sao-auto-width-post '.esc_attr($thumbnail).'  ">';
		$output.='<div class="sao-post-warp">';
			$output.= sao_thumb($thumb);
			$output.='<div class="sao-details sao-auto-width-item">';
 				if($title == true) {
...
function sao_post_module_3($arge=false) { 
		...
		$thumbnail = has_post_thumbnail() ? ' has-post-thumbnail ':'';
		$output ='<div class="sao-post sao-post-module-3 sao-auto-width-post '.esc_attr($thumbnail).'  ">';
...
Sao LightSlider
*********************************************************************/
function sao_lightslider($item,$slider_options=false) {
	...
	$slider_options["slideMargin"] = 0;
 	...
 	?>
 	<div class="sao-slider-options" ><?php echo json_encode($slider_options);?></div>
    <?php
