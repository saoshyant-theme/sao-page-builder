 ...
 "use strict";
    ...
    $.fn.sao_lightSlider = function (options) {
        ...
        refresh.chbreakpoint = function () {
		 ...
		 function timer() {
			  $el.parents('.sao-element-item').find('.sao-timer').stop();
			$el.parents('.sao-element-item').find('.sao-timer').clearQueue();
 	        $el.parents('.sao-element-item').find('.sao-timer').animate({"width":0}, 0);
         $el.parents('.sao-element-item').find('.sao-timer').animate({"width":slideWidth}, options.pause);
    	 }
        ...
        plugin = {
            ...
            controls: function () {
                if (settings.controls) {
                    $el.after('<div class="lSAction"><a class="lSPrev">' + settings.prevHtml + '</a><a class="lSNext">' + settings.nextHtml + '</a></div>');
                      if (settings.timer) {
                   		 $el.after('<div class="sao-timer"></div>');
					  }
            ...
            pager: function () {
                ...
                refresh.createPager = function () {
                        ...
                        if (settings.mode === 'slide') {
						 ...
						 if (settings.gallery_thumb === true) {
							...
							if(thumb_ratio > page_thumb_ratio  ){
								var thumb_img ='sao-thumb-horizontal'; 
							} else{
								var thumb_img ='sao-thumb-vertical'; 
 							}
							
							
 							var thumb_title = $children.eq(i).find('.sao-title a').html();
							
 							var thumb = '<div class="sao-thumb-warp"><div class="sao-slider-thumb '+thumb_img+'" ><a href="#"><img src="' + thumb_src + '" width="'+thumb_width+'" height="'+thumb_height+'" /></a></div><div class="sao-title"><a href="#">'+thumb_title+'</a></div></div>';
					...
					$cSouter.find('.lSPager .sao-slider-thumb').each(function(index, block) {
                ...
                if (settings.pager) {
                    ...
                    $slide.after('<div class="sao-page-list"><ul class="lSPager ' + cl + ' '+sao_gallery_thumb+'"></ul></div>');
 ...
 timer();                    }
        ...
        $(window).on('resize orientationchange', function (e) {
            setTimeout(function () {
                ...
                refresh.init();
				timer();
 				 $el.find('.sao-thumb').each(function(index, element) {
